...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Your Little Zoo" },
      { name: "description", content: "A small, cozy world made just for you." },
      { property: "og:title", content: "Your Little Zoo" },
      { property: "og:description", content: "A small, cozy world made just for you." },
